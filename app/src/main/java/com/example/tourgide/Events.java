...
public class Events extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String[] Names = getResources().getStringArray(R.array.list_names3);
        final String[] Desc = getResources().getStringArray(R.array.list_Desc3);

        final TypedArray Images = getResources().obtainTypedArray(R.array.list_Image3);
        ...
        lst = (ListView) rootView.findViewById(R.id.lst3);
